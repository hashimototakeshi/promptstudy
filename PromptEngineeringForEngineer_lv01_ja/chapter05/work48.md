...
**【シチュエーション】**
AIが作成したチェックリストに従って調査を進めた結果、高橋さんは、**「N+1クエリ」**がパフォーマンス劣化の直接的な原因であることを突き止めました。彼はこの技術的な問題を、プロダクトマネージャーの田中さんに説明し、修正作業の工数を確保してもらう必要があります。しかし、田中さんはエンジニアではないため、「N+1クエリ」と言っても伝わらない可能性があります。
:::

さあ、実際にGeminiなどの対話AIを使い、**この複雑な技術的問題を、非エンジニアにも分かりやすく説明するための「たとえ話」をAIに作成させる**プロンプトを作成してみましょう。
...
お疲れ様でした。
次のワークではAIの出力をAI自身に評価・改善させる「メタ認知」の技術を使い、出力の質を高める手法について学んでいきましょう。
